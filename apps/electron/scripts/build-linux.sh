...
echo "=== Building Jonwork AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Jonwork-x86_64.AppImage or Jonwork-aarch64.AppImage
BUILT_APPIMAGE_NAME="Jonwork-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Jonwork-x64.AppImage, Jonwork-arm64.AppImage
APPIMAGE_NAME="Jonwork-${ARCH}.AppImage"
