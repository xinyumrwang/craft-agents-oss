#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for Jonwork server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running Jonwork server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for Jonwork server
