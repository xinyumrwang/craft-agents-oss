#!/usr/bin/env bun
/**
 * Build script for standalone Jonwork server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for Jonwork
...
# Jonwork Server — convenience entry point
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building Jonwork Server ${version} for ${platform}-${arch} ===`);
