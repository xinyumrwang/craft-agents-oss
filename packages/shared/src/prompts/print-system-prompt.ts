#!/usr/bin/env bun
/**
 * Debug script to print the full Jonwork system prompt with annotations.
...
printAnnotation('  2. Jonwork Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Jonwork additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Jonwork Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
